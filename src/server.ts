...
// Server factory: creates and configures the MCP server with all tools.
// Shared by stdio (index.ts) and SSE (sse-server.ts) entry points.
...
export function createServer(dbService: DatabaseService): McpServer {
    ...
    server.tool(
        ...
        {},
        async () => memoryOverviewTool.handle()
    );
    ...
    server.tool(
        ...
        async (params) => storeDevMemoryTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => quickStoreTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => getRecentContextTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => listDevMemoriesTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => getDevMemoryTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => searchTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => searchEnhancedTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => listMemoriesByTagTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => analyzeMemoryQualityTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => multiAIAnalyzeMemoryQualityTool.handle(params)
    );
    ...
    server.tool(
        ...
        async (params) => interactiveCuratorTool.handle(params)
    );
